...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("permissions", "0006_alter_modulepermission_options"),
    ]
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                "permissions": [
                    ...
                    (
                        "empresas.ver",
                        "Ver las empresas del sistema y en cuáles trabaja cada usuario",
                    ),
                    ("empresas.editar", "Crear y editar empresas"),
                    (
                        "empresas.asignar",
                        "Asignar usuarios a empresas y elegir en cuál entran por defecto",
                    ),
                    ...
                    (
                        ...
                        "Ver únicamente los equipos que uno tiene a su cargo",
                    ),
                    ("activos.crear", "Registrar nuevos activos en el inventario"),
                    ("activos.editar", "Editar la ficha técnica de un activo"),
                    (
                        "activos.asignar",
                        "Asignar, trasladar y devolver activos entre custodios y áreas",
                    ),
                    ...
                    (
                        ...
                        "Administrar el catálogo de componentes y repuestos",
                    ),
