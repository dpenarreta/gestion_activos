"""Materializa los permisos del módulo de adjuntos (§18) y los suma al rol
"Superusuario".

Mismo criterio que `0002`, `0003` y `0004`: se añaden los que falten sin quitar
ninguno, para no deshacer un recorte deliberado del rol. Es idempotente.
"""
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0004_sumar_permisos_alertas"),
