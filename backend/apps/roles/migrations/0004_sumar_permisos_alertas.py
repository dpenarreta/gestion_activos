"""Materializa los permisos del centro de alertas (§19) y los suma al rol
"Superusuario".

Mismo criterio que `0002` y `0003`: se añaden los que falten sin quitar
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0003_sumar_permisos_exportacion"),
